...
public abstract class EnderiteItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 26, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(OuterEndWildsModItems.ENDERITE_INGOT.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("outer_end_wilds:enderite"))),
					20f, 0.2f);
			registerHelper.register(ResourceLocation.parse("outer_end_wilds:enderite"), armorMaterial);
