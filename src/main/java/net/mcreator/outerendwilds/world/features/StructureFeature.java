package net.mcreator.outerendwilds.world.features;
...
import net.mcreator.outerendwilds.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, OuterEndWildsMod.MODID);
